       ...
       // private bool deleted;
        ...
        public MainWindow()
        {
           ...
           // Customers.CollectionChanged += Customers_CollectionChanged; //observable collection informuje o każdej zmianie w obiekcie
            dataGrid.PreviewKeyDown += DataGrid_KeyUp;
        ...
        //                context.Customer.Remove((Customer)item);
        //            }
        //            context.SaveChanges();
        //            deleted = false;
        //        }
        ...
        private void DataGrid_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Delete)
            {
                ...
                //var item = context.Customer.Single(p => p.CustomerID == dataGrid.SelectedIndex);
        ...
        private void readButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var filtered = from q in context.Customer
                               where q.LastName.Equals(lastName)
                               select q;
                Customers.Clear();
